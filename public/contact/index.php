...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $address = "michael.aguilera@gmail.com";
        $mail->AddAddress($address, "Michael Aguilera");
        $mail->Subject    = "Learn Lingala Contact Form Submission | " . $name;
...
<div class="jumbotron">
    ...
    <p>I am Social Worker with a Maters Degree in Social Work (MSW) and Professional Web Developer &amp; Tech Consultant. Currently I am a County Consultant to the State of California for the developement of CWS/New System Project - a new State-wide child welfare case management system. 
    </p>
</div>
...
<div class="jumbotron">
            ...
            <div class="wrapper">
                        ...
                        <form method="post" action="<?php echo BASE_URL; ?>contact/">
                            ...
                            <input style="margin-left: 25%;" type="submit" value="Send">
