                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        //if (!plugin.config.perQuestionResponseMessaging) {
                         //   questionHTML.append('<a href="#" class="button  ' + BtnSuccessClass + ' ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                        //} else {
                        //    questionHTML.append('<a href="#" class="button  ' + BtnSuccessClass + ' ' + nextQuestionClass + '">' + nextText + '</a>');
                         //   questionHTML.append('<a href="#" class="button ' + BtnSuccessClass + ' ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a>');
                      //  BtnClass }
...
// If we're not showing responses per question, show next question button and make it check the answer too
                        if (!plugin.config.perQuestionResponseMessaging) {
                            questionHTML.append('<a href="#" class=" ' + BtnClass + ' ' + BtnSuccessClass + ' ' + nextQuestionClass + ' ' + checkAnswerClass + '">' + nextText + '</a>');
                        } else {
                            questionHTML.append('<a href="#" class=" ' + BtnClass + ' ' + BtnSuccessClass + ' ' + checkAnswerClass + '">' + plugin.config.checkAnswerText + '</a> &emsp; ');
                            questionHTML.append('<a href="#" class=" ' + BtnClass + ' ' + BtnSuccessClass + ' ' + nextQuestionClass + '">' + nextText + '</a>');
                        }
